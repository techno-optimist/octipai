  ...
  return (
    ...
    >
      <div
        ...
        style={
          {
            "--aurora": "repeating-linear-gradient(100deg,#9333ea_10%,#a5b4fc_15%,#3b82f6_20%,#ddd6fe_25%,#6366f1_30%)",
      ...
      >
        <div
          className={cn(
            ...
            `[--aurora:repeating-linear-gradient(100deg,var(--purple-500)_10%,var(--indigo-400)_15%,var(--blue-500)_20%,var(--violet-200)_25%,var(--indigo-500)_30%)]`,
